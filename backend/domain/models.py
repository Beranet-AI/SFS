# SmartFarmSystemEnterprise/backend/domain/models.py
...
class Sensor:
    ...
    name: str
    hardware_address: Optional[str]   # کانال/پورت/آدرس Modbus
    is_active: bool
...
class SensorReading:
    ...
    ts: datetime
    value: float
    raw_payload: Optional[Dict]       # مثلا JSON خام
...
class AlertRule:
    ...
    condition_expression: str         # برای Rule Engine
    is_active: bool
