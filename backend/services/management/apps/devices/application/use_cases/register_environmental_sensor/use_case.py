...
class RegisterEnvironmentalSensorUseCase:
    def __init__(
        ...
        *,
        ...
        approve_schema_uc: ApproveTelemetrySchemaUseCase | None = None,
    ) -> None:
        ...
        self._approve_schema_uc = (
            approve_schema_uc or ApproveTelemetrySchemaUseCase()
        )
    ...
    def execute(
        ...
        self._approve_schema_uc.execute(
            ApproveSchemaInputDTO(
                schema_id=schema_output.schema_id,
                approved_by=input_dto.approved_by,
            )
        )
