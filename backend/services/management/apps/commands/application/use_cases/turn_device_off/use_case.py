...
from .input_dto import TurnDeviceOffInputDTO
...
class TurnDeviceOffUseCase:
    """
    Turn a device off using the ON_OFF command.
    """
    ...
    def execute(
        self, dto: TurnDeviceOffInputDTO, *, created_by: str
    ):
