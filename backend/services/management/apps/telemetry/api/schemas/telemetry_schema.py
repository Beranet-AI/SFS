# backend/services/management/apps/telemetry/api/schemas/telemetry_schema.py
...
class TelemetrySchema(models.Model):
    ...
    device_type = models.CharField(
        max_length=64,
        db_index=True,
        help_text="Logical device type (e.g. TEMPERATURE_SENSOR)",
    )

    version = models.CharField(
        max_length=16,
        help_text="Schema version (e.g. v1, v2)",
    )

    json_schema = models.JSONField(
        help_text="Official JSON Schema definition",
    )
    ...
    created_by = models.CharField(
        max_length=128,
        help_text="Who registered this schema",
    )
    ...
    approved_by = models.CharField(
        ...
        null=True,
        blank=True,
        help_text="Who approved this schema",
    )
    ...
    def approve(self, approved_by: str):
        ...
        Deactivation of previous schemas must be handled outside.
        """
        self.is_active = True
    ...
    def next_version(cls, device_type: str) -> str:
        """
        Simple incremental versioning per device_type.
        v1, v2, v3, ...
        """
